        ...
        <tbody className="bg-ocean-400">
          {team.users.map((user) => (
            <tr className="text-xl" key={user.id}>
              ...
              <td className="p-4">
                <SubmitButton
                  className="inline-flex justify-center rounded-md border border-transparent bg-rose-500/80 px-4 py-2 text-sm font-medium text-white transition duration-200 hover:bg-red-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:bg-red-500 disabled:opacity-50"
